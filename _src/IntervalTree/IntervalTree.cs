...
namespace IntervalArray
{
    ...
    public partial class IntervalTree<TKey, TValue> : IEnumerable<Interval<TKey>> where TKey : struct, IComparable<TKey>
    {
        ...
        public List<KeyValuePair<Interval<TKey>, TValue>> Search(TKey val)
        {
            var result = new List<KeyValuePair<Interval<TKey>, TValue>>();
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        public List<KeyValuePair<Interval<TKey>, TValue>> Search(Interval<TKey> i)
        {
            var result = new List<KeyValuePair<Interval<TKey>, TValue>>();
        ...
        private void RotateRight(IntervalNode<TKey, TValue> node)
        {
            var pivot = node.Left;
